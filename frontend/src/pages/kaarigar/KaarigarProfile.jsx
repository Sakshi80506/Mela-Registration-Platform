...
import { User, Sparkles, Upload, Save, CheckCircle2, Image as ImageIcon, Trash2, AlertTriangle, X, Edit3, Phone, MapPin, Mail, LogOut } from 'lucide-react';
...
const KaarigarProfile = () => {
  const { currentUser, userProfile, kaarigarProfile, refreshKaarigarProfile, deleteAccount, logout } = useAuth();
  ...
  return (
    <div style={{ maxWidth: '850px', margin: '0 auto' }}>
      ...
      <div className="card" style={{ marginTop: '2rem', padding: '1.5rem 2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem', border: '1px solid var(--color-border)' }}>
        <div>
          ...
          <p style={{ color: 'var(--color-text-muted)', fontSize: '0.85rem', marginTop: '0.2rem', marginBottom: 0 }}>
            Safely log out of your artisan account on this device.
          </p>
        </div>
        <button
          type="button"
